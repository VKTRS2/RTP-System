...
func copy2Dest(docPath string, dest, src interface{}) error {
	...
	case *common.ExternalCancellationReason1Code:
		if typedDest == nil {
			return errors.New("nil pointer... in unmarshalling common.ExternalCancellationReason1Code data for" + docPath)
		}

		*typedDest, err = common.ToExternalCancellationReason1Code(src)
		return err
