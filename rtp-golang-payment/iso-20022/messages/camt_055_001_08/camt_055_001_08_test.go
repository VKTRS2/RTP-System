...
const Example_camt_055_001_08 = "example-document-camt_055_001_08.xml"
...
func TestDocumentcamt_055_001_08(t *testing.T) {
	...
	d := camt_055_001_08.Document{
		CstmrPmtCxlReq: camt_055_001_08.CustomerPaymentCancellationRequestV08{
			...
			CtrlData: &camt_055_001_08.ControlData1{
			...
			Undrlyg: []camt_055_001_08.UnderlyingTransaction24{{
				OrgnlGrpInfAndCxl: &camt_055_001_08.OriginalGroupHeader15{
					GrpCxlId: common.MustToMax35Text(common.Max35TextSample),
					Case: &common.Case5{
						Id: common.MustToMax35Text(common.Max35TextSample),
						Cretr: common.Party40Choice{
							Pty: &common.PartyIdentification135{
					...
					NbOfTxs:      common.MustToMax15NumericText(common.Max15NumericTextSample),
					CtrlSum:      xsdt.MustToDecimal(xsdt.DecimalSample),
					GrpCxl:       xsdt.MustToBoolean(xsdt.BooleanSample),
					CxlRsnInf: []camt_055_001_08.PaymentCancellationReason5{{
						...
						Rsn: &camt_055_001_08.CancellationReason33Choice{
							Cd:    common.MustToExternalCancellationReason1Code(common.ExternalCancellationReason1CodeSample),
							Prtry: common.MustToMax35Text(common.Max35TextSample),
						},
				...
				OrgnlPmtInfAndCxl: []camt_055_001_08.OriginalPaymentInstruction34{{
					PmtCxlId: common.MustToMax35Text(common.Max35TextSample),
					Case: &common.Case5{
						Id: common.MustToMax35Text(common.Max35TextSample),
						Cretr: common.Party40Choice{
							Pty: &common.PartyIdentification135{
					...
					NbOfTxs:   common.MustToMax15NumericText(common.Max15NumericTextSample),
					CtrlSum:   xsdt.MustToDecimal(xsdt.DecimalSample),
					PmtInfCxl: xsdt.MustToBoolean(xsdt.BooleanSample),
					CxlRsnInf: []camt_055_001_08.PaymentCancellationReason5{{
						Orgtr: &common.PartyIdentification135{
							Nm: common.MustToMax140Text(common.Max140TextSample),
							PstlAdr: &common.PostalAddress24{
					...
					TxInf: []camt_055_001_08.PaymentTransaction109{{
						CxlId: common.MustToMax35Text(common.Max35TextSample),
						Case: &common.Case5{
							Id: common.MustToMax35Text(common.Max35TextSample),
							Cretr: common.Party40Choice{
								Pty: &common.PartyIdentification135{
	...
	err = ioutil.WriteFile(Example_camt_055_001_08, b, fs.ModePerm)
	require.NoError(t, err)
	defer os.Remove(Example_camt_055_001_08)
