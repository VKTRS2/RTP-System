		...
		CdtrPmtActvtnReq: pain_013_001_07.CreditorPaymentActivationRequestV07{
			...
			PmtInf: []pain_013_001_07.PaymentInstruction31{{
				...
				CdtTrfTx: []pain_013_001_07.CreditTransferTransaction35{{
					...
					IntrmyAgt1: &common.BranchAndFinancialInstitutionIdentification6{
						FinInstnId: common.FinancialInstitutionIdentification18{
							BICFI: common.MustToBICFIDec2014Identifier(common.BICFIDec2014IdentifierSample),
							ClrSysMmbId: &common.ClearingSystemMemberIdentification2{
								ClrSysId: &common.ClearingSystemIdentification2Choice{
					...
					IntrmyAgt2: &common.BranchAndFinancialInstitutionIdentification6{
						FinInstnId: common.FinancialInstitutionIdentification18{
							BICFI: common.MustToBICFIDec2014Identifier(common.BICFIDec2014IdentifierSample),
							ClrSysMmbId: &common.ClearingSystemMemberIdentification2{
								ClrSysId: &common.ClearingSystemIdentification2Choice{
					...
					IntrmyAgt3: &common.BranchAndFinancialInstitutionIdentification6{
						FinInstnId: common.FinancialInstitutionIdentification18{
							BICFI: common.MustToBICFIDec2014Identifier(common.BICFIDec2014IdentifierSample),
							ClrSysMmbId: &common.ClearingSystemMemberIdentification2{
								ClrSysId: &common.ClearingSystemIdentification2Choice{
