...
const Example_pain_014_001_07 = "example-document-pain_014_001_07.xml"

func TestDocumentpain_014_001_07(t *testing.T) {

	d := pain_014_001_07.Document{
		CdtrPmtActvtnReqStsRpt: pain_014_001_07.CreditorPaymentActivationRequestStatusReportV07{
			GrpHdr: pain_014_001_07.GroupHeader87{
			...
			OrgnlGrpInfAndSts: pain_014_001_07.OriginalGroupInformation30{
				...
				StsRsnInf: []pain_014_001_07.StatusReasonInformation12{{
					...
					Rsn: &pain_014_001_07.StatusReason6Choice{
				...
				NbOfTxsPerSts: []pain_014_001_07.NumberOfTransactionsPerStatus5{{
			...
			OrgnlPmtInfAndSts: []pain_014_001_07.OriginalPaymentInstruction31{{
				...
				TxInfAndSts: []pain_014_001_07.PaymentTransaction104{{
					...
					PmtCondSts: &pain_014_001_07.PaymentConditionStatus1{
						AccptdAmt: &common.ActiveCurrencyAndAmount{
							Ccy:   common.MustToActiveCurrencyCode(common.ActiveCurrencyCodeSample),
							Value: xsdt.MustToDecimal(xsdt.DecimalSample),
						},
						GrntedPmt: xsdt.MustToBoolean(xsdt.BooleanSample),
						EarlyPmt:  xsdt.MustToBoolean(xsdt.BooleanSample),
					},
					ChrgsInf: []common.Charges7{{
					...
					DbtrDcsnDtTm: common.MustToISODateTime(common.ISODateTimeSample),
					...
					OrgnlTxRef: &pain_014_001_07.OriginalTransactionReference29{
						...
						PmtCond: &common.PaymentCondition1{
							...
							ImdtPmtRbt: &common.AmountOrRate1Choice{
						...
						NclsdFile: []common.Document12{{
							Tp: common.DocumentType1Choice{
								Cd: common.MustToExternalDocumentType1Code(common.ExternalDocumentType1CodeSample),
								Prtry: &common.GenericIdentification1{
									Id:      common.MustToMax35Text(common.Max35TextSample),
									SchmeNm: common.MustToMax35Text(common.Max35TextSample),
									Issr:    common.MustToMax35Text(common.Max35TextSample),
								},
							...
							Id: common.MustToMax35Text(common.Max35TextSample),
							IsseDt: common.DateAndDateTime2Choice{
								Dt:   common.MustToISODate(common.ISODateSample),
								DtTm: common.MustToISODateTime(common.ISODateTimeSample),
							},
							Nm:     common.MustToMax140Text(common.Max140TextSample),
							LangCd: xsdt.MustToString(xsdt.StringSample),
							Frmt: common.DocumentFormat1Choice{
							...
							DgtlSgntr: &common.PartyAndSignature3{
						...
						UltmtCdtr: &common.PartyIdentification135{
							Nm: common.MustToMax140Text(common.Max140TextSample),
							PstlAdr: &common.PostalAddress24{
								AdrTp: &common.AddressType3Choice{
									Cd: common.MustToAddressType2Code(common.AddressType2CodeSample),
	...
	err = ioutil.WriteFile(Example_pain_014_001_07, b, fs.ModePerm)
	require.NoError(t, err)
	defer os.Remove(Example_pain_014_001_07)
